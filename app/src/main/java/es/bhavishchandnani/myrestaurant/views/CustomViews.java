...
public class CustomViews {
    public static void setCustomToolbarView(AppCompatActivity activity, String title, int leftBtnImageId, int rightBtnImageId, final ToolbarClickInterface listener) {
